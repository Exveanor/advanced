...
let catImage = new ImageBox(main, 'https://http.cat/202');
let catImage2 = new ImageBox(main, 'https://http.cat/500');
let catImage3 = new ImageBox(main, 'https://http.cat/413');
 
let carousel = new Carousel(catImage, catImage2, catImage3);